...
Disponible dans les modes Host et User, ce bouton permet de telecharger une copie complete de tous les fichiers vers un dossier de votre choix. Les fichiers sont sauvegardes dans un sous-dossier nomme avec la date et l'heure (ex: "Backup_Spiralydata_2025-01-31_14-30-45").

- **Mode Host** : Copie les fichiers locaux du serveur
- **Mode User** : Telecharge tous les fichiers depuis le serveur (Host)
...
3. Un dossier "Backup_Spiralydata_YYYY-MM-DD_HH-MM-SS" sera cree avec tous les fichiers du serveur
